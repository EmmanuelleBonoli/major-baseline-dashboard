...
Pour chaque livre, on y retrouve la description du monde (ton, pitch, thèmes, règles),
...
(Gemini via un Worker Cloudflare) qui peut réécrire un passage ou compléter un champ vide
