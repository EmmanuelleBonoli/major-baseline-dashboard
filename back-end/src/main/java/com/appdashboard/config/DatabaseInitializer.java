...
public class DatabaseInitializer {
    ...
    public DatabaseInitializer(UserRepository userRepository, AppStatsRepository appStatsRepository, ApplicationRepository applicationRepository) {
    ...
    private void generateStatsForApp(Store store) {
        ...
        List<AppStats> stats = com.appdashboard.features.AppStats.StatsMockGenerator.generateStats(store, startDate, endDate);
